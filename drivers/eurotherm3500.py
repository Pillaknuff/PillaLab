...
class Eurotherm3500( minimalmodbus.Instrument ):
    ...
    def __init__(self, portname, slaveAddress):
        subordinateaddress = slaveAddress
    ...
    @property
    def setpoint(self):
        return self.get_sp_loop1()

    @setpoint.setter
    def setpoint(self, value):
        self.set_sp_loop1(value)
    ...
    def temperature(self):
        return self.get_pv_loop1()
    
    @property
    def rampRate(self):
        return self.get_sprate_loop1()

    @rampRate.setter
    def rampRate(self, value):
        if self.is_sprate_disabled_loop1():
            print("ramprate was diabled, enablint")
            self.enable_sprate_loop1()
        self.set_sprate_loop1(value)
    
    @property
    def pid(self):
        print("PID setting not implemented for eurotherm 3500")
        return [0,0,0]
