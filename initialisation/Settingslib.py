def getDefaultSettings():
        ...
        settings["growthcontrol.Controlerallocation"] = [[5],[1],[2],[0],[4],[6],[3]]             # Allocation of the different Controllers to the respective fields (GUI definition)
        settings["growthcontrol.Fieldnames"] = ["Sb2Te3","Tm","Te","Mn", "MnTe", "Bi2Te3","BaF2"]                # Naming of the GUI fields
        settings["growthcontrol.Shutterallocation"] = [0,1,2,3,4,5]                       # Allocate the shutters to the respective fields
        ...
        settings["growthcontrol.Controlernicknames"] = ["Wine","Vodka","Rum","Cachassa","Tequilla","Whiskey","Cointreau","Beer"]      # refering name of the Eurotherms, has to be unique!
        settings["growthcontrol.standardramprates"] = [10,10,10,10,10,10,10,10]                       #
        settings["growthcontrol.bepposition"] = ["open","open","open","open","open","open","open"]                          # for each Cell gives the setting of the shutter, which should be used for bep reading
        settings["growthcontrol.com"] = ['com10','com11','com4','com13','com5','com9','com15','com6']                           # com adresses of the individual eurotherms
        settings["growthcontrol.slaveadress"] = [1,1,1,1,1,1,1,1]                               # slaveadresses, standard is 1
        settings["growthcontrol.baud"] = [9600,9600,9600,9600,9600,9600,19200,9600]                                # baud rate for eurotherms, standard is 9600
        settings["growthcontrol.type"] = ['eurotherm2408','eurotherm2408','eurotherm2408','eurotherm2408','eurotherm2408','eurotherm2408','eurotherm3508','eurotherm2408']          # refers to eurotherm type, differs in what driver file is assigned to the eurotherm, so far only eurotherm2408 is implemented
