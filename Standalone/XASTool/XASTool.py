...
#    Oct 04, 2020 03:27:48 PM CEST  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Label1_1 = tk.Label(top)
        self.Label1_1.place(relx=0.031, rely=0.217, height=20, width=82)
        self.Label1_1.configure(activebackground="#f9f9f9")
        self.Label1_1.configure(activeforeground="black")
        self.Label1_1.configure(background="#d9d9d9")
        self.Label1_1.configure(disabledforeground="#a3a3a3")
        ...
        self.Label1_1.configure(highlightbackground="#d9d9d9")
        self.Label1_1.configure(highlightcolor="black")
        self.Label1_1.configure(text='''Filename''')
        ...
        self.Toolframe.configure(highlightbackground="#d9d9d9")
        self.Toolframe.configure(highlightcolor="black")

        self.NormalizeBox = tk.Checkbutton(top)
        self.NormalizeBox.place(relx=0.787, rely=0.244, relheight=0.034
                , relwidth=0.111)
        self.NormalizeBox.configure(activebackground="#ececec")
        self.NormalizeBox.configure(activeforeground="#000000")
        self.NormalizeBox.configure(background="#d9d9d9")
        self.NormalizeBox.configure(disabledforeground="#a3a3a3")
        self.NormalizeBox.configure(foreground="#000000")
        self.NormalizeBox.configure(highlightbackground="#d9d9d9")
        self.NormalizeBox.configure(highlightcolor="black")
        self.NormalizeBox.configure(justify='left')
        self.NormalizeBox.configure(text='''Normalize Data''')
        self.NormalizeBox.configure(variable=XASTool_support.normalizeData)

        self.Statusbar = tk.Label(top)
        self.Statusbar.place(relx=0.389, rely=0.0, height=21, width=115)
        self.Statusbar.configure(background="#d9d9d9")
        self.Statusbar.configure(disabledforeground="#a3a3a3")
        self.Statusbar.configure(font="-family {Comic Sans MS} -size 14 -weight normal -slant roman -underline 0 -overstrike 0")
