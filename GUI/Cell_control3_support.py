...
#    Feb 14, 2022 05:59:05 PM CET  platform: Windows NT
...
def startMainGUI(controlBackend): # main caller
    ...
    substratenentrynumber = 7 # used to refer to substrate as an special entry, by default the last one
    ...
    Tselectors = [w.Tselector1,w.Tselector2,w.Tselector3,w.Tselector4,w.Tselector5,w.Tselector6,w.Tselector7]                                                # select cell length used to label cells, substrate is unique
    Tsettinpoints = [w.Tset1,w.Tset2,w.Tset3,w.Tset4,w.Tset5,w.Tset6,w.Tset7,w.Tset_S]                                                                  # setpoints inputs, also contains substrate
    Tramps = [w.rset1,w.rset2,w.rset3,w.rset4,w.rset5,w.rset6,w.rset7,w.rset_S]                                                                         # ramprate inputs, also substrate
    ...
    Tdisplays = [w.LabelTcell1,w.LabelTcell2,w.LabelTcell3,w.LabelTcell4,w.LabelTcell5,w.LabelTcell6,w.LabelTcell7,w.LabelT_S]                                # Temperature displays for the individual cells
    Cellnames = [w.Headerlabel1,w.Headerlabel2,w.Headerlabel3,w.Headerlabel4,w.Headerlabel5,w.Headerlabel6,w.Headerlabel7]
    ...
    Autotuneboxes = [w.Autotunecheck1,w.Autotunecheck2,w.Autotunecheck3,w.Autotunecheck4,w.Autotunecheck5,w.Autotunecheck6,w.Autotunecheck7,w.AutotunecheckS]    # Autotune checkboxes
