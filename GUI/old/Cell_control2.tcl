...
#  Jul 20, 2020 12:26:29 AM CEST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top42 {base} {
    ...
    button $top.but54 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text set 
    vTcl:DefineAlias "$top.but54" "S2_set" vTcl:WidgetProc "Toplevel1" 1
    text $top.tex56 \
    ...
    vTcl:DefineAlias "$top.tex61" "T2_read" vTcl:WidgetProc "Toplevel1" 1
    text $top.tex62 \
        -background white -font TkTextFont -foreground black \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -insertbackground black -selectbackground #c4c4c4 \
    ...
    vTcl:DefineAlias "$top.tex62" "T2_set" vTcl:WidgetProc "Toplevel1" 1
    text $top.tex63 \
        -background white -font TkTextFont -foreground black \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -insertbackground black -selectbackground #c4c4c4 \
    ...
    vTcl:DefineAlias "$top.tex63" "T3_read" vTcl:WidgetProc "Toplevel1" 1
    text $top.tex64 \
        -background white -font TkTextFont -foreground black \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -insertbackground black -selectbackground #c4c4c4 \
    ...
    vTcl:DefineAlias "$top.tex64" "T3_set" vTcl:WidgetProc "Toplevel1" 1
    button $top.but65 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text set 
    vTcl:DefineAlias "$top.but65" "SetT2" vTcl:WidgetProc "Toplevel1" 1
    button $top.but66 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text set 
    vTcl:DefineAlias "$top.but66" "SetT3" vTcl:WidgetProc "Toplevel1" 1
    ...
    label $top.lab83 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text ok 
    vTcl:DefineAlias "$top.lab83" "smallStatus" vTcl:WidgetProc "Toplevel1" 1
    ttk::combobox $top.tCo44 \
        -font TkTextFont -textvariable shutterAngle -foreground {} \
        -background {} -takefocus {} 
    vTcl:DefineAlias "$top.tCo44" "S2_angleselect" vTcl:WidgetProc "Toplevel1" 1
    text $top.tex45 \
        -background white -font TkTextFont -foreground black \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -insertbackground black -selectbackground #c4c4c4 \
    ...
    vTcl:DefineAlias "$top.tex45" "T4_read" vTcl:WidgetProc "Toplevel1" 1
    text $top.tex46 \
        -background white -font TkTextFont -foreground black \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -insertbackground black -selectbackground #c4c4c4 \
    ...
    vTcl:DefineAlias "$top.tex46" "T4_set" vTcl:WidgetProc "Toplevel1" 1
    button $top.but49 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text set 
    vTcl:DefineAlias "$top.but49" "SetT4" vTcl:WidgetProc "Toplevel1" 1
    text $top.tex50 \
        -background white -font TkTextFont -foreground black \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -insertbackground black -selectbackground #c4c4c4 \
    ...
    vTcl:DefineAlias "$top.tex50" "T_rampSpeed" vTcl:WidgetProc "Toplevel1" 1
    button $top.but51 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text ramp 
    vTcl:DefineAlias "$top.but51" "RampT1" vTcl:WidgetProc "Toplevel1" 1
    ...
    button $top.but52 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text ramp 
    vTcl:DefineAlias "$top.but52" "RampT2" vTcl:WidgetProc "Toplevel1" 1
    button $top.but53 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text ramp 
    vTcl:DefineAlias "$top.but53" "RampT3" vTcl:WidgetProc "Toplevel1" 1
    button $top.but55 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background #5f5f5f -command RampT4 -disabledforeground #a3a3a3 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text ramp 
    vTcl:DefineAlias "$top.but55" "RampT4" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab56 \
        -activebackground #f9f9f9 -activeforeground black \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) \
    ...
    ttk::combobox $top.tCo57 \
        -font TkTextFont -textvariable whichcell -foreground {} \
        -background {} -takefocus {} 
    vTcl:DefineAlias "$top.tCo57" "BEP_cellSelect" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl:DefineAlias "$top.tex60" "BEPdisp1" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab61 \
        -activebackground #f9f9f9 -activeforeground black \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) \
    ...
    button $top.but62 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background #5f5f5f -command MeasureBEP -disabledforeground #a3a3a3 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text measure 
    vTcl:DefineAlias "$top.but62" "MeasureBEP" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl:DefineAlias "$top.tex65" "BEPdisp2" vTcl:WidgetProc "Toplevel1" 1
    text $top.tex66 \
        -background white -font TkTextFont -foreground black \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -insertbackground black -selectbackground #c4c4c4 \
    ...
    vTcl:DefineAlias "$top.tex66" "BEPdisp3" vTcl:WidgetProc "Toplevel1" 1
    text $top.tex67 \
        -background white -font TkTextFont -foreground black \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -insertbackground black -selectbackground #c4c4c4 \
    ...
    vTcl:DefineAlias "$top.tex67" "BEPdisp4" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab68 \
        -activebackground #f9f9f9 -activeforeground black \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) \
    ...
    ttk::combobox $top.tCo71 \
        -font TkTextFont -textvariable sampleposselect -foreground {} \
        -background {} -takefocus {} 
    vTcl:DefineAlias "$top.tCo71" "sample_pos_select" vTcl:WidgetProc "Toplevel1" 1
    ...
    label $top.lab74 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text Status 
    vTcl:DefineAlias "$top.lab74" "Statusheading" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab75 \
        -activebackground #f9f9f9 -activeforeground black \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -font {-family {Segoe UI} -size 14} -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text {all closed} 
    vTcl:DefineAlias "$top.lab75" "StatusWhat" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab76 \
        -activebackground #f9f9f9 -activeforeground black \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -font {-family {Segoe UI} -size 14} -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text 00:00 
    vTcl:DefineAlias "$top.lab76" "StatusTime" vTcl:WidgetProc "Toplevel1" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.lab43 \
    ...
    place $top.but48 \
        ...
        -bordermode ignore 
    place $top.but54 \
        -in $top -x 0 -relx 0.217 -y 0 -rely 0.364 -width 30 -relwidth 0 \
